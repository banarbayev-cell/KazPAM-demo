  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-[9999]">
      <div className="bg-[#0A0F24] w-[420px] p-6 rounded-xl border border-white/10 animate-fade">
        ...
        <h2 className="text-2xl font-bold mb-4 text-white">Удалить политику?</h2>
        <p className="text-gray-300 mb-6">
          Вы уверены, что хотите удалить политику <span className="text-red-400 font-semibold">{policyName}</span>?  
